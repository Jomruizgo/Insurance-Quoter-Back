---
name: generate-spec
description: Genera una spec técnica ASDD en .claude/specs/<feature>.spec.md. Obligatorio antes de cualquier implementación.
...
- [ ] Alineada con arquitectura y stack (ver `.claude/rules/backend.md`, `frontend.md`, `database.md`)
